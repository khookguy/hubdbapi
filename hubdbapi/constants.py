...
hubdb_update_table_row_url_template = \
    "https://api.hubapi.com/hubdb/api/v2/tables/{table_id}/rows/{row_id}?hapikey={hs_key}"
hubdb_update_table_row_cell_template = \
    "https://api.hubapi.com/hubdb/api/v2/tables/{table_id}/rows/{row_id}/cells/{cell_num}?hapikey={hs_key}"
